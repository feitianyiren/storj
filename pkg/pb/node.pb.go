...
func (NodeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_node_baa84f904dccd886, []int{0}
}
...
func (NodeTransport) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_node_baa84f904dccd886, []int{1}
}
...
func (*NodeAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_baa84f904dccd886, []int{2}
}
...
func (*NodeStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_baa84f904dccd886, []int{3}
}
...
func (*NodeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_baa84f904dccd886, []int{4}
}
...
func init() { proto.RegisterFile("node.proto", fileDescriptor_node_baa84f904dccd886) }

var fileDescriptor_node_baa84f904dccd886 = []byte{
